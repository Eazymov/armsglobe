...
function attachMarkerToCountry(countryName, importance) {
  ...
  var template = document.querySelector(".marker");
  ...
  var countryLayer = marker.querySelector(".marker__country-text");
  ...
  var nameLayer = marker.querySelector(".marker__country-text");
